...
const [fullname, setFullname] = useState("constantine rusous")
const [password,setPassword] = useState("constantine password")
const [address, setAddress] = useState("123 street lane") 
          ...
          <form class="max-w-lg border rounded-lg mx-auto">
            <div class="flex flex-col gap-4 p-4 md:p-8">
              <div>
                ...
                <input onChange    name="username" class="w-full bg-gray-50 text-gray-800 border focus:ring ring-indigo-300 rounded outline-none transition duration-100 px-3 py-2" />
              </div>
